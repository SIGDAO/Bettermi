  ...
  const content: JSX.Element = (
    <div className="screen">
      <div className="bettermidapp-generate-free-nft-error">
        {location.pathname === '/errorNotEnoughFunds' && (
          <BackButton />
          )}
        ...
        <Link to={navigatePath} target={navigatePath === "https://discord.com/invite/MATW3Dcdcw" ? "_blank" : undefined} rel={navigatePath === "https://discord.com/invite/MATW3Dcdcw" ? "noopener noreferrer" : undefined}>
