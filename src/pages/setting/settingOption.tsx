...
const SettingOption: React.FunctionComponent<ISettingOptionProps> = (props) => {
  ...
  return (
    <Link to={disabled ? "#" : navigatePath!} className={disabled ? "disabled-link" : undefined} target={inBettermiPath ? undefined : "_blank" } rel={inBettermiPath ? undefined : "noopener noreferrer" } style={{ width: "100%"}}>
