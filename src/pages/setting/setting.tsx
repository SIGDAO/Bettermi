      ...
      <div className="bettermidapp-settings-1">
        ...
        <div className="settings-7DUKxJ settings">
          ...
          <div className="cards-azNBHQ">
            ...
            <Link to={`https://${process.env.REACT_APP_NETWORK === "Signum" ? "explorer.signum.network/address": "testnet.explorer.signum.network/address"}/${userAccountId}`} target="_blank" rel="noopener noreferrer">
